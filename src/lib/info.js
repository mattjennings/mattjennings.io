...
export const bio = `\
I'm ${firstName}, a software developer based in Canada working for <a href="https://appetize.io">Appetize.</a>
`
export const bioText = bio.replace(/<[^>]*>/g, '')

export const github = 'mattjennings'
export const twitter = 'mattjennings44'
